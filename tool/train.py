...
import sys
#sys.path.append('/home/agalex/PycharmProjects/torch_1_3_0')
# import apex
...
def get_parser():
    ...
    #parser.add_argument('--config', type=str, default='/home/agalex/PycharmProjects/torch_1_3_0/segmentation/config/voc2012/voc2012_pspnet101.yaml', help='config file')
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.sync_bn:
        if args.multiprocessing_distributed:
            ...
            from segmentation.lib.sync_bn.modules import BatchNorm2d
...
#    train_transform = transform.Compose([
#        transform.Resize((args.train_h, args.train_w)), #crop_type='rand', padding=mean, ignore_label=args.ignore_label),
#        transform.ToTensor(),
#        transform.Normalize(mean=mean, std=std)])
